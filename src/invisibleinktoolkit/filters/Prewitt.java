...
public class Prewitt implements Filter
{
    ...
    public Prewitt(final int startbits, final int endbits) {
        this(null, startbits, endbits);
    }
    
    public Prewitt(final BufferedImage image, final int startbits, final int endbits) {
    ...
    public int getValue(final int xpos, final int ypos) throws Exception {
        ...
        final int reddiff = (int)Math.sqrt(Math.pow(this.getRed(matrix1right) + this.getRed(matrix1rightup) + this.getRed(matrix1rightdown) - (this.getRed(matrix1left) + this.getRed(matrix1leftup) + this.getRed(matrix1leftdown)), 2.0) + Math.pow(this.getRed(matrix2up) + this.getRed(matrix2upleft) + this.getRed(matrix2upright) - (this.getRed(matrix2down) + this.getRed(matrix2downleft) + this.getRed(matrix2downright)), 2.0));
        final int greendiff = (int)Math.sqrt(Math.pow(this.getGreen(matrix1right) + this.getGreen(matrix1rightup) + this.getGreen(matrix1rightdown) - (this.getGreen(matrix1left) + this.getGreen(matrix1leftup) + this.getGreen(matrix1leftdown)), 2.0) + Math.pow(this.getGreen(matrix2up) + this.getGreen(matrix2upleft) + this.getGreen(matrix2upright) - (this.getGreen(matrix2down) + this.getGreen(matrix2downleft) + this.getGreen(matrix2downright)), 2.0));
        final int bluediff = (int)Math.sqrt(Math.pow(this.getBlue(matrix1right) + this.getBlue(matrix1rightup) + this.getBlue(matrix1rightdown) - (this.getBlue(matrix1left) + this.getBlue(matrix1leftup) + this.getBlue(matrix1leftdown)), 2.0) + Math.pow(this.getBlue(matrix2up) + this.getBlue(matrix2upleft) + this.getBlue(matrix2upright) - (this.getBlue(matrix2down) + this.getBlue(matrix2downleft) + this.getBlue(matrix2downright)), 2.0));
