...
public class StartEndFilterWindow extends JDialog implements ActionListener
{
    ...
    public StartEndFilterWindow(final Frame parent, final StegoAlgorithm algorithm) {
        ...
        final Filterable algo = (Filterable)algorithm;
        ...
        if (e.getActionCommand().equalsIgnoreCase("cancel")) {
            ...
            if (!this.mLSBMatch.shouldMatch()) {
                ...
                if (this.mAlgorithm instanceof Filterable) {
                    final Filterable falgo = (Filterable)this.mAlgorithm;
